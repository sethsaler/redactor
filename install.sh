...
verify_installation() {
    ...
    echo ""
    echo "Usage:"
    echo "  redact                                 # Launch GUI (recommended)"
    echo "  redact document.pdf                    # CLI: SSN mode"
    echo "  redact statement.pdf --mode bank       # CLI: Bank statement mode"
    echo "  redact data.csv --mode all -v          # CLI: Comprehensive mode"
    echo "  redact ./documents/ --recursive        # CLI: Batch process"
    echo ""
